...
export const recyclingServices = [
  ...
  },
  {
    ...
    content:
      "**What can be recycled:** This service mainly collects bags, clothes, curtains, paired shoes and so on.  \n&nbsp;  \n**How:** The recycling process takes place weekly with the collection between 7am and 5pm. You should place the tied carrier bag at the front edge of your property by 7am and ensure it is placed alongside your other recycling boxes.  \n&nbsp;  \n**What cannot be recycled:** Things that cannot be collected involve duvets and pillows (their covers and cases are still acceptable). There are additional opportunities to get your textile waste recycled, which are TRAID charity and Salvation Army Textile Banks.  \n&nbsp;  \n[Link for more details.](https://www.hounslow.gov.uk/info/20128/household_recycling_and_waste_collections/1600/clothing_textiles_and_shoe_recycling)",
  },
  {
  ...
  },
  {
    ...
    content:
      "**What can be recycled:** This service mainly collects plastic carrier bags, plastic wrapping and packaging, polystyrene, nappies and so on.  \n&nbsp;  \n**How:** The collection process takes place every two weeks with the collection between 7am and 5pm. You will be given a 140-litre wheelie bin that should be placed at the front edge of your property by 7am to be collected. There are alternative options where you can present your waste in either a larger 240-litre bin (subject to approval) or up to 3 black sacks.  \n&nbsp;  \n**What cannot be recycled:** It is not recommended to put any recyclable items into this bin.  \n&nbsp;  \n[Link for more details.](https://www.hounslow.gov.uk/info/20002/recycling_and_rubbish/1603/household_waste)",
  },
  {
