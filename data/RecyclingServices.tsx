...
export const flatRecyclingServices = [
  ...
  },
  {
    ...
    content:
      "Textiles such as bags, clothes, curtains, paired shoes and so on cannot be collected from flats. However, there are still opportunities to get your textile waste recycled, which are TRAID charity and Salvation Army Textile Banks. [Link for more details.](https://www.hounslow.gov.uk/info/20128/household_recycling_and_waste_collections/24/recycling_and_rubbish_collections_from_your_flat/2)",
  },
  {
    title: "Small Electrical Items",
    description: "Small electrical items can be donated to charity.",
    content:
      "Small electrical items such as telephones, cameras, CD/DVD players, hairdryers and so on cannot be collected from flats. However, you can utilise TRAID charity as an opportunity to get your small electrical appliances recycled. [Link for more details.](https://www.hounslow.gov.uk/info/20128/household_recycling_and_waste_collections/24/recycling_and_rubbish_collections_from_your_flat/2)",
  },
  {
  ...
  },
  {
    ...
    content:
      "This service mainly collects plastic carrier bags, plastic wrapping and packaging, polystyrene, nappies and so on. The collection process takes place every ??? weeks. It is not recommended to put any recyclable items into this bin.",
  },
  {
    title: "Bulky Waste Collection Service",
    description:
      "The Bulky Waste Collection Service is used to remove any household waste and large items that are not suitable for the bin rubbish collection.",
    content:
      "This service mainly collects broken furniture, fridges, unused bedding, bicycles and so on. It is recommended to wait until you have 5 items to recycle, as this is what the minimum charge applies to (£40 for individuals and £70 for landlords). The price then gets incremented per additional item (£8 for individuals and £14 for landlords). The day you wish your items to be collected can be booked in advance via phone (call 020 8583 5555 and select option 1), with the process taking place anytime between 7am and 3pm on that day. Please place your items at the agreed collection point (you will need your managing agent's approval to store your waste in a communal area before calling us to book a collection). Please clearly label the items with the date of collection and service request number which will be provided upon booking. Things that cannot be collected include garden waste, pianos and tyres. Items placed at locations other than the agreed upon collection point and heavy items (i.e. cannot be lifted by two people) will not be collected either. [Link for more details.](https://www.hounslow.gov.uk/info/20002/recycling_and_rubbish/30/tidy_town_bulky_waste_collection)",
  },
  {
    title: "Clinical Waste Collection Service",
    description:
