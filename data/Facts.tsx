export const facts = [
  ...
  },
  {
    ...
    content:
      ...
      "However, for non-household waste, there are more and more items not being sent for recycling - " +
      "the number has increased by approximately 250% in the 5-years period. " +
